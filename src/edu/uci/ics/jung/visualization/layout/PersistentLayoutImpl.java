...
public class PersistentLayoutImpl<V, E> extends ObservableCachingLayout<V,E>
     ...
     * (non-Javadoc)
     * 
     * @see edu.uci.ics.edu.uci.ics.jung.visualization.Layout#incrementsAreDone()
     */
    public boolean done() {
     ...
     * (non-Javadoc)
     * 
     * @see edu.uci.ics.edu.uci.ics.jung.visualization.Layout#lockVertex(edu.uci.ics.edu.uci.ics.jung.graph.Vertex)
     */
