...
public class KStepMarkov<V,E> extends RelativeAuthorityRanker<V,E> {
    public final static String RANK_SCORE = "edu.uci.ics.jung.algorithms.importance.KStepMarkovExperimental.RankScore";
    private final static String CURRENT_RANK = "edu.uci.ics.jung.algorithms.importance.KStepMarkovExperimental.CurrentRank";
