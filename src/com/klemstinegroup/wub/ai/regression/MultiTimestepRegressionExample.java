package com.klemstinegroup.wub.ai.regression;
...
public class MultiTimestepRegressionExample {
    ...
    private static File baseDir = initBaseFile("C:/Users/Paul/Desktop/Wub/rnnRegression");
    ...
    private static int numOfVariables = 3;  // in csv.
...
//                evaluation.evalTimeSeries(lables, predicted);
    ...
    private static List<String> prepareTrainAndTest(int trainSize, int testSize, int numberOfTimesteps) throws IOException {
        Path rawPath = Paths.get(baseDir.getAbsolutePath() + "/inputdata.csv");
