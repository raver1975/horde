...
//
//	public MidiPumper() {
//		Info info = MidiCommon.getMidiDeviceInfo("ReMOTE LE", false);
...
//			sendMidi(getKeyName(message.getData1()),0);
//			break;
//
//		case 0x90:
//			strMessage = "note On " + getKeyName(message.getData1()) + " velocity: " + message.getData2();
//			sendMidi(getKeyName(message.getData1()),message.getData2());
//			break;
//
//		case 0xa0:
...
//	}
//
//	private void sendMidi(String keyName, int data2) {
//		 for (AudioObject au:list){
//			 au.sendMidi(keyName,data2);
//		 }
//		
//	}
//
...
//	private static final String[] SYSTEM_MESSAGE_TEXT = { "System Exclusive (should not be in ShortMessage!)", "MTC Quarter Frame: ", "Song Position: ", "Song Select: ", "Undefined", "Undefined", "Tune Request", "End of SysEx (should not be in ShortMessage!)", "Timing clock", "Undefined", "Start",
