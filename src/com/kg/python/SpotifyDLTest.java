...
public class SpotifyDLTest {
    ...
    */
        ...
        SpotifyDLTest.spotifyAndSpleeter("https://open.spotify.com/track/2DGa7iaidT5s0qnINlwMjJ", new File(System.getProperty("user.dir") + File.separator + "test.mp3"), STEM5);
    }
