...
public class Shell extends Thread {
            ...
            public String execute(Shell ci, String[] args) {
                if (args.length >= 3) {
                    try {
                        ...
                        putResponse(Shell.this.execute(subargs));
                        newOut.close();
            ...
            public String execute(Shell ci, String[] args) {
                if (args.length > 1) {
                    ...
                    for (Iterator i = commands.iterator(); i.hasNext();) {
                        putResponse(Shell.this.execute(
                                (String[]) i.next()));
                    }
                } else {
    ...
    private void dumpCommands() {
        ...
        for (Iterator i = sortedKeys.iterator(); i.hasNext();) {
            ...
            String help = ((ShellCommand) commandList.get(cmdName)).getHelp();
    ...
    public String execute(String[] args) {
        ...
        if (args.length > 0) {
            ...
            ci = (ShellCommand) commandList.get(args[0]);
            try {
                if (ci != null) {
    ...
    public boolean load(String filename) {
        try {
            ...
            while ((inputLine = br.readLine()) != null) {
                String response = Shell.this.execute(inputLine);
